...
import java.util.List;
    public class MainFragment extends Fragment implements View.OnClickListener, RecylerviewAdapter.OnUserClickListener{
        ...
        private void setupRecyclerView() {
            ...
            RecylerviewAdapter adapter=new RecylerviewAdapter(context,listPersonInfo,this);
